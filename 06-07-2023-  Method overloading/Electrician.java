class Electrician{
	...
	static void skill()
	{
		System.out.println("Running skill() in Electrician ");
	}
	
	static void skill(String name)
	{
		System.out.println("Running skill(String) in Electrician and his name is "+name);
	}
	...
	{
		System.out.println("The contact detail of Electrician is "+phoneNumber);
	}
	
	static void address(String address)
	
	{
		System.out.println("The address of Electrician is "+address);
	}
	...
	static void frame()
	{
		System.out.println("Running frame in Electrician");
